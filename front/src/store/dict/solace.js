...
const phrases = [
  ...
  "Ты молодец, но нужно стараться",
  "Старайся, я в тебя верю",
  "Ох",
  "Зря ты так",
  "Ты спишь?",
  "Учиться будем?",
  "Мы так тут долго будем",
  "Да что ж такое",
  "Я тобой горжусь!",
  "Еще немного, еще чуть-чуть",
  "Держись",
  "Ты же не хочешь, чтобы я подсказывала?",
  "Двоечник",
  "Опять 25",
  "Не ссы в трусы ы",
  "Даже я уже запомнила",
  "Работай, не отвлекайся",
  "Если не будешь ошибаться, получишь награду",
  ...
  "Пчела хоть и жалит, да мёд дает. ",
